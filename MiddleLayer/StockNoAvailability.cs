...
{
    public  class StockNoAvailability : IStockAvailability
    {
        ...
        {
            Stock_Availability_Validation = FactoryValidation<StockAvaiabilityValidationNull>.Create<StockAvaiabilityValidationNull>("StockAvaiabilityValidationNull");
